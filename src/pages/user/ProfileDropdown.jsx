                ...
                <div className="flex items-center space-x-3">
                    {user?.profileImage ? (
                        <img
                            ...
                            alt={user.name}
                            className="w-12 h-12 rounded-full object-cover shadow-lg border-2 border-blue-200"
                        />
                    ) : (
                        <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center shadow-lg border-2 border-blue-200">
                    ...
                    <div className="flex-1">
                        <h3 className="text-sm font-semibold text-slate-800">{user?.name || 'User'}</h3>
            ...
            <div className="px-4 py-3 border-t border-slate-200">
                <div className="flex flex-wrap gap-2">
                    <button 
                        ...
                        className="flex-1 inline-flex items-center justify-center px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium rounded-lg transition-colors duration-200"
                    >
